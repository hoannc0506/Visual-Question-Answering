...
def main():
    parser = argparse.ArgumentParser(description='Train CLIP VQA')
    parser.add_argument('--device', default="cuda:0")

    args = parser.parse_args()

    # visual_pretrained = 'openai/clip-vit-base-patch32'
    # text_pretrained = 'openai/clip-vit-base-patch32'
    device = args.device
    ...
    image_preprocessor = model.image_preprocessor
    ...
    wandb_logger = wandb.init(
        project="VQA",
        name=f"openai_clip-vit-base-patch32"
    )
